...
% The largest error occurs at t = pi/2. This occurs because this is where
% the derivative is at its maximum. Therefore, the gap between x values
% close to this region is harder to narrow due to the greater magnitude in
% slope.
%% Exercise 4
%
...
% Error message
% Warning: Failure at t=5.066046e-01.  Unable to meet integration tolerances
%without reducing the step size below the smallest value allowed
%(1.776357e-15) at time t.

% This error message occurs because the solution as shown on the graph
% approaches a vertical asymptote, meaning the step size needs to be
% reduced constantly. The smalles limit allowed by MATLAB is eventually
% reached which produces the error above.
